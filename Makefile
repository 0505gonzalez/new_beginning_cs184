...
RM = /bin/rm -f 
all: transform
transform: main.o shaders.o Transform.o display.o variables.h shaders.h Transform.h
	$(CC) $(CFLAGS) -o transforms shaders.o main.o Transform.o display.o $(INCFLAGS) $(LDFLAGS) 
main.o: main.cpp shaders.h Transform.h variables.h
	$(CC) $(CFLAGS) $(INCFLAGS) -c main.cpp
shaders.o: shaders.cpp shaders.h
	$(CC) $(CFLAGS) $(INCFLAGS) -c shaders.cpp
readfile.o: variables.h 
